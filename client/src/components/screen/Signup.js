...
const Signup = () => {
    ...
    const uploadPic = () => {
            ...
            fetch('https://api.cloudinary.com/v1_1/get-items/image/upload',{
                method : 'post',
                body : data
            })
            .then((res) => res.json())
    ...
    const submitData = () => {
        ...
        if(image){
            ...
            setUrl("https://res.cloudinary.com/get-items/image/upload/v1611063458/default_bcx69t.jpg")
        }
    }
        ...
        <>
            {
                ...
                <section className='form-main-container'>
                    <section>
                        <img src='https://res.cloudinary.com/get-items/image/upload/v1611064862/main-logo.jpg'
                            alt='main-logo'
                        />
                    </section>
